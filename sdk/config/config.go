...
type APIKeyMetadata = internalconfig.APIKeyMetadata
type APIKeyAuditEvent = internalconfig.APIKeyAuditEvent
...
const (
	...
	DefaultStreamingKeepAliveSeconds = internalconfig.DefaultStreamingKeepAliveSeconds
)
