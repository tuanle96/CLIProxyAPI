...
func TestConvertOpenAIRequestToGeminiCLI_VideoBase64InImageUrl(t *testing.T) {
	inputJSON := []byte(`{
	...
	output := ConvertOpenAIRequestToGeminiCLI("gemini-3.5-flash", inputJSON, false)
...
func TestConvertOpenAIRequestToGeminiCLI_VideoBase64InVideoUrlObject(t *testing.T) {
	inputJSON := []byte(`{
		"model": "gemini-3.5-flash",
		"messages": [
			{
...
func TestConvertOpenAIRequestToGeminiCLI_VideoBase64InVideoUrlString(t *testing.T) {
	inputJSON := []byte(`{
		"model": "gemini-3.5-flash",
		"messages": [
			{
...
func TestConvertOpenAIRequestToGeminiCLI_VideoBase64IgnoresMalformedURLsAndParsesParams(t *testing.T) {
	inputJSON := []byte(`{
		"model": "gemini-3.5-flash",
		"messages": [
			{
